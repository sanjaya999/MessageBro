...
const userNamefind = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json(new ApiResponse(200, user, "userfound"));
  } catch (error) {}
});

export { registerUser, loginUser, findUser, getallUsers, userNamefind };
